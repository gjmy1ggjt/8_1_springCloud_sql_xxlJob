 ...
 */
@Service
public class DashboardUsersPlaceOrderBusiness implements DashboardDrawBusinessI {

    private static final Logger logger = LoggerFactory.getLogger(DashboardUsersPlaceOrderBusiness.class);
    ...
    public DashboardVO drawDashboard(DashboardVO vo) {
        ...
        Map jsonMap = DashboardUtil.getDrawDashboardMap(map, url + "/view/usersPlaceOrderData");
        vo.setData(jsonMap);
        return vo;
    }
    ...
    public String[] getDrawBusinessName() {
        return new String[]{StatisticsDrawType.USERMODULE, "下单用户统计图"};
    }
}
