 ...
 */
@Service
public class DashboardProductSalesBusiness implements DashboardDrawBusinessI {
    ...
    public DashboardVO drawDashboard(DashboardVO vo) {
        ...
        String postUrl = url + "/productSales/list";
        ...
        vo.setData(DashboardUtil.dataForJsonTransverse(mapData,"产品交易额统计图","交易额","单位(元)"));
        return vo;
    }
    ...
    public String[] getDrawBusinessName() {
        return new String[]{StatisticsDrawType.SALESMODULE, "产品交易额统计图"};
    }
}
